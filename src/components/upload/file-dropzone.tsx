...
import { Music4, Headphones, AudioLines } from 'lucide-react';
    ...
    <div className="w-full px-4">
      ...
      >
        <Card
          role="button"
          className={cn(
            'py-8 sm:py-12 focus-visible:ring-ring ring-offset-background flex flex-1 cursor-pointer flex-col items-center justify-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 aria-disabled:pointer-events-none aria-disabled:opacity-60 border-dashed border-[1.5px] overflow-hidden',
            className
          )}
          gradient={true}
          degrees={120}
          ...
          {...props}
        >
          <CardContent className="text-muted-foreground/40 flex flex-col items-center justify-center p-4 sm:p-6">
            <div className="flex">
              <motion.div
              ...
              >
                <Music4
                  strokeWidth="2px"
                  className="text-muted-foreground/20 group-hover:text-[#adfa1d]/80 h-6 w-6 sm:h-10 sm:w-10 transition-colors duration-300 ease-out"
                />
              </motion.div>
            ...
            <p className="hidden sm:block text-muted-foreground/80 mt-1 text-sm">
